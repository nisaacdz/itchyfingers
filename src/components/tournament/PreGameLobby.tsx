...
export const PreGameLobby = ({
  message = "The tournament is about to begin!",
  tournamentSession,
}: PreGameLobbyProps) => {
  ...
  return (
    <div className="flex flex-col items-center justify-center text-center h-full p-8 text-slate-200">
      ...
      <p className="text-slate-400 mb-6 max-w-md">
        Get your fingers ready! The typing challenge will appear here once the
        tournament starts. You can see other joined players on the left.
      </p>
