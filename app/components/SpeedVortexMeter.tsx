...
const SpeedVortexMeter = ({ speed }: { speed: number }) => {
    ...
    <div className="relative w-48 h-48">
      ...
      >
        ...
        <div className="absolute inset-0 overflow-hidden">
          ...
          >
            {/* Wave */}
            <svg viewBox="0 0 100 56" className="absolute w-full h-full animate-wave opacity-40 text-current">
              <path fill="currentColor" d="M0 15 C30 28 70 4 100 15 L100 0 L0 0 Z" />
              <path fill="currentColor" d="M0 30 C30 18 70 40 100 30 L100 0 L0 0 Z" />
            </svg>
          </div>
        </div>
        {/* Speed Text */}
...
export default SpeedVortexMeter;
